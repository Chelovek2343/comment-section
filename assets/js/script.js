...
function editSectionItem() {
    editButtons.forEach((editButton) => {
        editButton.addEventListener('click', () => {
            ...
            editContainer.innerHTML = `
                <form>
                    <div class="edit__textarea">
                        <textarea class='editTextarea'></textarea>
                    </div>
            ...
            const updateButton = editContainer.querySelector('.updateButton');
            const editTextarea = editContainer.querySelector('.editTextarea');
            ...
            updateButton.addEventListener('click', () => {
                editForm.addEventListener('submit', (e) => {
                    ...
                    item.textContent = editTextarea.value;
